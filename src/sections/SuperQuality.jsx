const SuperQuality = () => {
  return (
    <div className="bg-pale-blue">
      <section
        id="about-me"
        className="flex flex-col gap-10 bg-pale-blue lg:flex-row"
      >
        <div className="flex-1">
          ...
          <p className="info-text mt-4 break-keep lg:max-w-lg">
            능숙한 Git 사용 뿐만 아니라 TypeScript를 활용해 Type Safety한 코드를
            작성할 수 있습니다. 그리고 열린 마음으로 새로운 기술들을 적극
            수용하고 있습니다.
          </p>
